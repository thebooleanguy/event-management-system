<script>
  ...
  const username = 'Mahinda';
  const events = [
    { imageUrl: '/images/event1.jpg', title: '' },
    { imageUrl: '/images/event2.jpg', title: '' },
    { imageUrl: '/images/event3.jpg', title: 'Universal Merit Awards 2024' },
    { imageUrl: '/images/event4.jpg', title: '' },
  ];
  const categories = ['Live Musicals', 'Exhibitions', 'Meetups', 'Food Festivals'];
</script>
  ...
  <main class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-4 gap-8">
      <div class="col-span-3">
        <h3 class="text-xl font-semibold mb-4">Trending Events</h3>
